    ...
    public class ProductoController : Controller
    {
        ...
        public JsonResult Guardar(Producto objeto)
        {
            ...
            if (objeto.IdProducto == 0)
            {
                ...
                resposta = CD_Producto.Instancia.RegistrarProducto(objeto);
            }
            else
            {
                resposta = CD_Producto.Instancia.ModificarProducto(objeto);
            }
        ...
        {
            bool resposta = CD_Producto.Instancia.EliminarProducto(id);
        ...
        {
            bool resposta = CD_ProductoTienda.Instancia.RegistrarProductoTienda(objeto);
            return Json(new { resultado = resposta }, JsonRequestBehavior.AllowGet);
        }
        ...
        {
            bool resposta = CD_ProductoTienda.Instancia.ModificarProductoTienda(objeto);
            return Json(new { resultado = resposta }, JsonRequestBehavior.AllowGet);
        }
        ...
        {
            bool resposta = CD_ProductoTienda.Instancia.EliminarProductoTienda(id);
            return Json(new { resultado = resposta }, JsonRequestBehavior.AllowGet);
        }
