...
namespace ControlePacientes.Controllers
{
    public class VentaController : Controller
    {
        ...
        public JsonResult ObtenerProductoPorTienda(int IdTienda = 1)
        {
        ...
        public JsonResult ObterTodosProdutos()
        {

            List<Producto> oListaProductoTienda = CD_Producto.Instancia.ObtenerProducto();
            oListaProductoTienda = oListaProductoTienda.ToList();
        ...
        {
            bool resposta = CD_ProductoTienda.Instancia.ControlarStock(idproducto, idtienda, cantidad, restar);
        ...
        public JsonResult Guardar(string xml)
        {
            ...
            int resposta = 0;
            resposta = CD_Venta.Instancia.RegistrarVenta(xml);
            if (resposta != 0)
                return Json(new { estado = true, valor = resposta.ToString() }, JsonRequestBehavior.AllowGet);
            else
